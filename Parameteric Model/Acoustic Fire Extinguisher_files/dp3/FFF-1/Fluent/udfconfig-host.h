...
#define DOMAIN_ID(t)STRUCT_REF(t,3096,int)
#define PHASE_DOMAIN_INDEX(t)STRUCT_REF(t,3100,int)
#define DOMAIN_N_DOMAINS(t)STRUCT_REF(t,3108,int)
#define DOMAIN_SUPER_DOMAIN(t)STRUCT_REF(t,3296,Domain *)
#define DOMAIN_SUB_DOMAIN(t,i)(STRUCT_OFF(t,3120,Domain *)[i])

#define THREAD_STORE(t,nv)(STRUCT_OFF(t,62912,struct store_struct *)[nv])
#define THREAD_STORAGE(t,nv)(STRUCT_OFF(t,984,void *)[nv])
...
#define THREAD_DOMAIN(t)STRUCT_REF(t,976,Domain *)
#define THREAD_HEAD(t)STRUCT_REF(t,0,Thread_Head *)
#define THREAD_MATERIAL(t)(STRUCT_REF(THREAD_HEAD(t),13968,Material *))
...
#define P_EVAP_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),6872,int)
#define P_DEVOL_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),6876,int)
#define P_OXID_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),6880,int)
#define P_PROD_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),6884,int)
#define P_LAWS(p,in)STRUCT_OFF(P_INJECTION(p),788,int)[in]
