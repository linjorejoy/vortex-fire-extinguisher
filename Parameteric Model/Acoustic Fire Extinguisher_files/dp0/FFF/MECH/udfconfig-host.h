...
#define DOMAIN_ID(t)STRUCT_REF(t,3072,int)
#define PHASE_DOMAIN_INDEX(t)STRUCT_REF(t,3076,int)
#define DOMAIN_N_DOMAINS(t)STRUCT_REF(t,3084,int)
#define DOMAIN_SUPER_DOMAIN(t)STRUCT_REF(t,3272,Domain *)
#define DOMAIN_SUB_DOMAIN(t,i)(STRUCT_OFF(t,3096,Domain *)[i])

#define THREAD_STORE(t,nv)(STRUCT_OFF(t,58576,struct store_struct *)[nv])
#define THREAD_STORAGE(t,nv)(STRUCT_OFF(t,936,void *)[nv])
#define THREAD_T0(t)STRUCT_REF(t,344,Thread *)
#define THREAD_T1(t)STRUCT_REF(t,352,Thread *)
#define THREAD_NEXT(t)STRUCT_REF(t,528,Thread *)
#define THREAD_SHADOW(t)STRUCT_REF(t,536,Thread *)
#define THREAD_ID(t)STRUCT_REF(t,856,int)
#define THREAD_NAME(t)STRUCT_REF(t,72,char *)
#define THREAD_N_ELEMENTS(t)STRUCT_REF(t,332,int)
#define THREAD_FLAGS(t)STRUCT_REF(t,864,int)
#define THREAD_SUB_THREAD(t,i)(STRUCT_OFF(t,624,Thread *)[i])
#define THREAD_SUB_THREADS(t)STRUCT_OFF(t,624,Thread *)
#define THREAD_SUPER_THREAD(t)STRUCT_REF(t,592,Thread *)
#define THREAD_DOMAIN(t)STRUCT_REF(t,928,Domain *)
#define THREAD_HEAD(t)STRUCT_REF(t,0,Thread_Head *)
#define THREAD_MATERIAL(t)(STRUCT_REF(THREAD_HEAD(t),13208,Material *))
...
#define P_EVAP_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),6888,int)
#define P_DEVOL_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),6892,int)
#define P_OXID_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),6896,int)
#define P_PROD_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),6900,int)
#define P_LAWS(p,in)STRUCT_OFF(P_INJECTION(p),804,int)[in]

typedef char UDF_Cache_Data[48];

#define MATERIAL_PROPERTY(m)STRUCT_OFF(m,128,Property)
#define PROPERTY_LENGTH 208
...
#define NWC_T(n,c) STRUCT_REF(((char *)NW_CELL(n)+c*504),264,real) 
